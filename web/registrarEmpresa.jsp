  ...
  <article class="main">   
      <section class="form-register">
        ...
        <form name="registroProfesional" action="ControlRegistroEmpresa" method="POST">
            ...
            <input class="controls" type="text" name="razonSocial" id="razonSocial" placeholder="Ingrese su Razón Social *" required="required">
            ...
            <input class="controls" type="text" name="direccion" id="direccion" placeholder="Ingrese su Dirección *" required="required">
