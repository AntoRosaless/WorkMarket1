...
<body class="grid-container">
  ...
  <article class="main">   
      <section class="form-register">
        ...
        <h5>Para registrarse como profesional complete el siguiente formulario, recuerde que los campos con * son obligatorios.</h5>
        <form name="registroProfesional" action="ControlRegistroProfesional" method="POST">
            ...
            <input class="controls" type="text" name="nombre" id="nombre" placeholder="Ingrese su Nombre *" required="required">
            <input class="controls" type="text" name="apellido" id="apellido" placeholder="Ingrese su Apellido *" required="required">
            ...
            <input class="controls" type="text" name="titulo" id="titulo" placeholder="Ingrese su Título *" required="required">
